...
Die Datei `tagesschau-ohne-schnickschnack.txt` ([Link]((../filterdatei/tagesschau-ohne-schnickschnack.txt))) teilt die verschiedenen Filter in vier Kategorien auf:
...
tagesschau.de##div.teasergroup:has([href*="sportschau"])
tagesschau.de##div.teasergroup:has([href*="sportschau"]) + div.teasergroup--docked
